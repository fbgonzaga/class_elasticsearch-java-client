...
public interface SearchApi {
    ...
    default CompletableFuture<ResponseEntity<List<Result>>> search(@ApiParam(value = "Query to be submitted") @Valid @RequestParam(value = "query", required = false) String query,@ApiParam(value = "Page number") @Valid @RequestParam(value = "page", required = false) Integer page) {
